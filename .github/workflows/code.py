...
# إعداد payload لطلب بيانات البيع والشراء (أول 20 عرض)
payload_sell = {
    "asset": "USDT",
    "fiat": "SDG",
    "tradeType": "SELL",
...
# دالة لإضافة البيانات إلى ملف Excel
...
# جلب بيانات البيع والشراء (مرة واحدة فقط)
...
for item in sell_data:
    ...
    # تطبيق الشروط: يجب أن يكون تاجرًا أو الكمية أكبر من 1000
...
# إضافة البيانات إلى ملف Excel وعرضها على الشاشة
if records:
    append_to_excel(records)
    print("\n✅ تم إضافة البيانات الجديدة بنجاح!\n")
